...
import ReportAnalyticByCategoryHandler from "../../../../../src/core/usecase/transaction/report/ReportAnalyticByCategory";
...
let reportAnalyticByCategory: ReportAnalyticByCategoryHandler;
...
beforeEach(async () => {
  ...
  reportAnalyticByCategory = new ReportAnalyticByCategoryHandler(reportRepository);
